...
class DBlockSave extends Component {
	render() {
		const { overlayColor, overlayImg, overlayImgOpacity, slidesPerView, spaceBetween, txtColor, autoplay, delay, speed, loop, effect, navigation, pagination } = this.props.attributes;
